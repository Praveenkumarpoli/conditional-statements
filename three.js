...
const membershipStatus = 'Regular';
const purchaseAmount = 450;

const regularDiscount5 = 0.05; // 5%
const regularDiscount10 = 0.10; // 10%
const vipDiscount10 = 0.10; // 10%
const vipDiscount15 = 0.15; // 15%
const vipDiscount20 = 0.20; // 20%

let basePrices = 0;
let discountRate = 0;

// Determine the base price based on membership status
...
if (basePrices > 0) {
    ...
    console.error("Unable to determine the final price due to invalid inputs.");
}

// task3

const gpa = 3.7;
const extracurricularActivities = 3;
const communityServiceHours = 110;
...
if (userAge < 18) {
    ...
    console.log("Registration denied: Please provide a valid email address.");
} else {
...
// task6
        // const teaOptions = ['black', 'green', 'herbal', 'oolong', 'white'];
        // let teaType = prompt(`Which type of tea would you like`);
        // teaType = teaType.toLowerCase();
        // switch (teaType) {
        //     case 'black':
        //         alert('You have selected Black Tea. Thank you!');
        //         break;
        //     case 'green':
        //         alert('You have selected Green Tea. Thank you!');
        //         break;
        //     case 'herbal':
        //         alert('You have selected Herbal Tea. Thank you!');
        //         break;
        //     case 'oolong':
        //         alert('You have selected Oolong Tea. Thank you!');
        //         break;
        //     case 'white':
        //         alert('You have selected White Tea. Thank you!');
        //         break;
        //     default:
        //         alert('Sorry, we do not have that type of tea.');
        //         break;
        // }
